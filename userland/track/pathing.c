        ...
        switch (v->type) {
          ...
          case NODE_MERGE:
            if (v->edge[DIR_AHEAD].owner == -1 || v->edge[DIR_AHEAD].owner == owner ||
                v->edge[DIR_AHEAD].reverse.owner == -1 || v->edge[DIR_AHEAD].reverse.owner == owner) {
          ...
          case NODE_BRANCH:
            if (v->edge[DIR_STRAIGHT].owner == -1 || v->edge[DIR_STRAIGHT].owner == owner ||
                v->edge[DIR_STRAIGHT].reverse.owner == -1 || v->edge[DIR_STRAIGHT].reverse.owner == owner) {
              edges[edges_len++] = &v->edge[DIR_STRAIGHT];
            }
            // edges[edges_len++] = &v->edge[DIR_STRAIGHT];
            if (v->edge[DIR_CURVED].owner == -1 || v->edge[DIR_CURVED].owner == owner ||
                v->edge[DIR_CURVED].reverse.owner == -1 || v->edge[DIR_CURVED].reverse.owner == owner) {
