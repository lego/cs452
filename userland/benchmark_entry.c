...
#define TIMING_START() t1 = io_get_time()
#define TIMING_LOG(msg) bwprintf(COM2, msg " time=%dus\n\r", io_time_difference_us(t2, t1))
#define TIMING_END(msg) t2 = io_get_time(); TIMING_LOG(msg)
...
void benchmark_entry_task() {
  ...
  TIMING_LOG("Task start and enter");
